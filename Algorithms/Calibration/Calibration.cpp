...
// IF BY CALIBRATED (BOUGUET'S METHOD)
    ...
    //Save parameters
            ...
            cvSave("Matrices/R1.xml",&_R1);
            cvSave("Matrices/P1.xml",&_P1);
            cvSave("Matrices/M2.xml",&_M2);
            cvSave("Matrices/D2.xml",&_D2);
            cvSave("Matrices/R2.xml",&_R2);
            cvSave("Matrices/P2.xml",&_P2);
            cvSave("Matrices/Q.xml",&_Q);
            cvSave("Matrices/mx1.xml",mx1);
            cvSave("Matrices/my1.xml",my1);
            cvSave("Matrices/mx2.xml",mx2);
            cvSave("Matrices/my2.xml",my2);
...
int main(int argc, char *argv[])
{
    ...
    //StereoCalib(argv[1], 9, 6, 0, 2.5);
    //StereoCalib("C:\\Users\\Boyan\\Documents\\Projects\\NSView\\build-NSView-Desktop_Qt_5_2_1_MSVC2010_32bit_OpenGL-Release\\release\\list.txt", 9, 6, 0, 2.5);
